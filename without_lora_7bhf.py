...
def forward_and_get_last_hidden_state(model, input_ids, attention_mask, last_layer="model.layers.20"):
    # embed_layer = model.model.get_input_embeddings()
...
def get_perplexity(input_ids, model, next_ids=None, top_k=None, last_layer="model.layers.20"):
    hidden_state_list = []
    hook_handles = []
